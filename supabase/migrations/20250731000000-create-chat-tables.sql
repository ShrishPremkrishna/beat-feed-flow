...
-- Function to ensure conversation participants are ordered correctly
...
-- Trigger to ensure conversation participants are ordered correctly
CREATE TRIGGER trigger_ensure_conversation_order
